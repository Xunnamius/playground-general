<?php
	...
	abstract class Controller
	{
		...
		private static $engine_has_run = FALSE;
		private static $reg_has_run = FALSE;
		private static $ajax_has_run = FALSE;
		
		private static $reg_method_objects = array();
		private static $ajax_method_objects = array();
		...
		public function filter($var, $type, $scope=NULL)
		{
			...
			if(isset($var))
			{
				switch((int) $type)
				{
					...
					case TYPE_INTEGER:
						$var = substr((string)$var, 0, strpos((string)$var, '.'));
